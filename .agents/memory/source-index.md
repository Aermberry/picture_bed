...
| 2026-09-24 | `openspec/config.yaml` | OpenSpec root config | schema `spec-driven`; `openspec/specs` + `openspec/changes` |
| 2026-09-24 | `node_modules/@fission-ai/openspec` | OpenSpec CLI dep | local bin `openspec`; package.json dep `^1.13.2` |
| 2026-09-24 | `.agents/skills/openspec-*` + `.agents/workflows/opsx-*` | OpenSpec AI workflows | generated by `openspec init` (Antigravity) |
